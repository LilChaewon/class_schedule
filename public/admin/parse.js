...
(function (root) {
  ...
  var DEPT_COLLEGE = {
    ...
    // ── 인문캠퍼스 학과 → 단과대학 (2022.12 학사구조(안) 기준. 일부 구(舊)학과명은
    //    가장 가까운 계열로 매칭한 추정치라 실제와 다르면 이 표만 고치면 됨) ──
    "인문대학": "인문대학", "인문콘텐츠학부 국어국문학전공": "인문대학", "인문콘텐츠학부 영어영문학전공": "인문대학",
    "인문콘텐츠학부 문헌정보학전공": "인문대학", "인문콘텐츠학부 미술사·역사학전공": "인문대학",
    "아시아·중동어문학부 일어일문학전공": "인문대학", "아시아·중동어문학부 중어중문학전공": "인문대학",
    "아시아·중동어문학부 아랍지역학전공": "인문대학", "아시아·중동어문학부 글로벌한국어학전공": "인문대학",
    "문예창작학과": "인문대학", "사학과": "인문대학", "철학과": "인문대학", "미술사학과": "인문대학",

    "사회과학대학": "사회과학대학", "법학과": "사회과학대학",
    "공공인재학부 행정학전공": "사회과학대학", "공공인재학부 정치외교학전공": "사회과학대학",
    "경상·통계학부 경제학전공": "사회과학대학", "경상·통계학부 국제통상학전공": "사회과학대학",
    "경상·통계학부 응용통계학전공": "사회과학대학", "국제통상학과": "사회과학대학",

    "경영대학": "경영대학", "경영학부 경영학전공": "경영대학", "경영학부 글로벌비즈니스학전공": "경영대학",
    "경영정보학과": "경영대학",

    "미래융합대학": "미래융합대학", "부동산학과": "미래융합대학", "멀티디자인학과": "미래융합대학",
    "심리치료학과": "미래융합대학", "사회복지학과": "미래융합대학", "법무행정학과": "미래융합대학",
    "미래융합경영학과": "미래융합대학", "회계세무학과": "미래융합대학", "복지상담경영학과": "미래융합대학",
    "복지상담학과": "미래융합대학", "물류유통경영학과": "미래융합대학", "유통산업경영학과": "미래융합대학",
    "행정서비스경영학과": "미래융합대학", "스포츠산업경영학과": "미래융합대학",

    "미디어·휴먼라이프대학": "미디어·휴먼라이프대학", "디지털미디어학부": "미디어·휴먼라이프대학",
    "청소년지도·아동학부 청소년지도학전공": "미디어·휴먼라이프대학", "청소년지도·아동학부 아동학전공": "미디어·휴먼라이프대학",
    "유아교육상담학과": "미디어·휴먼라이프대학", "미디어앤아트테크놀로지학과": "미디어·휴먼라이프대학",

    "AI·SW융합대학": "AI·SW융합대학", "인공지능·소프트웨어융합대학": "AI·SW융합대학",
    "융합소프트웨어학부": "AI·SW융합대학", "융합소프트웨어학부 응용소프트웨어전공": "AI·SW융합대학",
    "융합소프트웨어학부 데이터사이언스전공": "AI·SW융합대학",

    "디지털디자인대학": "디지털디자인대학", "디지털콘텐츠디자인학과": "디지털디자인대학",
    "융합디자인학과": "디지털디자인대학", "미용예술학과": "디지털디자인대학", "웹툰콘텐츠학과": "디지털디자인대학",
    "만화애니콘텐츠학과": "디지털디자인대학", "융합예술실용음악학과": "디지털디자인대학", "융합예술학융합전공": "디지털디자인대학"
  };
